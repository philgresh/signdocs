...
def make_note_for_user(user, title = 'You got this!', description = 'Confidence is key', priv = 'true')
...
def make_note_for_jack(name, description, priv)
  jack = User.find_by(email: 'jack_bruce@bruce.com')
  make_note_for_user(jack, name, description, priv)
end
